...
export default function BinarySearchPageNew() {
  const tabs = ["Problem", "Approach", "Iterative", "Recursive", "Complexity"];
  const [activeTab, setActiveTab] = useState("Problem");
  const [iterTab, setIterTab] = useState("C++");
  const [recTab, setRecTab] = useState("C++");
...
public static int binarySearch(int[] arr, int target) {
    return binarySearchRecursive(arr, target, 0, arr.length - 1);
            ...
            <h3 className="section-subtitle">Python Implementation:</h3>
            <div className="code-block">
              <div className="code-header"><span className="code-language">Python</span></div>
...
def binary_search(arr, target):
    return binary_search_recursive(arr, target, 0, len(arr) - 1)`}</pre>
            ...
            <h3 className="section-subtitle">JavaScript Implementation:</h3>
            <div className="code-block">
              <div className="code-header"><span className="code-language">JavaScript</span></div>
